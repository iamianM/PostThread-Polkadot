...
import "./css/TxButtonStyled.css"

import { useSubstrateState } from '../'
import utils from '../utils'

function TxButtonStyled({
  attrs = null,
  disabled = false,
  label,
  setStatus,
...
function TxGroupButton(props) {
  return (
    <Button.Group>
      <TxButtonStyled label="Unsigned" type="UNSIGNED-TX" color="grey" {...props} />
      <Button.Or />
      <TxButtonStyled label="Signed" type="SIGNED-TX" color="blue" {...props} />
      <Button.Or />
      <TxButtonStyled label="SUDO" type="SUDO-TX" color="red" {...props} />
    </Button.Group>
  )
}

export { TxButtonStyled, TxGroupButton }
