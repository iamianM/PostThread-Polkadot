        ...
        <>
            {type === "up" ?
                <button onClick={() => submitVote(1)}>
                    <svg className={`${fillUp} hover:fill-green-500 stroke-black stroke-1 hover:stroke-2`}
                ...
                :
                <button onClick={() => submitVote(-1)}>
                    <svg className={`${fillDown} hover:fill-red-500 stroke-black stroke-1 hover:stroke-2`}
