        ...
        <>
            {type === "up" ?
                <button onClick={() => submitVote(1)}>
                    <svg className={`${fillUp} hover:fill-success stroke-base-content stroke-1 hover:stroke-2`}
                ...
                :
                <button onClick={() => submitVote(-1)}>
                    <svg className={`${fillDown} hover:fill-error stroke-base-content stroke-1 hover:stroke-2`}
